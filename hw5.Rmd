...
Based on the Cp and adjusted R2 criterion, I would choose the 4-predictor (5 parameters) model. The best 4-predictor model is life_exp ~ population + murder + hs_grad + frost. It has the highest adjusted R2 and the lowest Cp value.
